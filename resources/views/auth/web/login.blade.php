        ...
        <div class="form-login">
            ...
            <form action="">
                <div class="form-group">
                    <label class="font-weight-bold" for="name">Nama <span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="password" id="password_confirmation" placeholder="Konfirmasi Kata Sandi">
                </div>
                <div class="form-group">
