<div class="products-container">
    ...
    <div class="products-wrapper home-recommendation-products-wrapper not-using-slick {{ count($products_reccomend) >= 5 ? 'justify-content-space-between' : '' }}">
        @foreach ($products_reccomend as $product)
            <a href="{{ url('/product/' . $product->product_slug) }}" class="product {{ count($products_reccomend) < 5 ? 'mr-lg-18' : '' }}">
