    ...
    <div class="footer-text-wrapper">
        <div class="header">
            ...
            <div class="social-media-wrapper">
                ...
                <a href="" class="social-media"><i class="zmdi zmdi-google"></i></a>
        ...
        <div class="links-wrapper">
            ...
            <ul>
                ...
                <li>
                    <a href="">MAKEUP TUTORIAL</a>
                </li>
                <li>
                    <a href="">BEAUTY INSPIRATION</a>
                </li>
                <li>
                    <a href="">LOOK BOOK</a>
                </li>
            ...
            <ul>
                ...
                <li>
                    <a href="">FOOT, HAND & NAIL CARE</a>
                </li>
            </ul>
            <ul>
                <li>
                    <a href="">MONDAY - FRIDAY: 9:00 - 19:00</a>
                </li>
                <li>
