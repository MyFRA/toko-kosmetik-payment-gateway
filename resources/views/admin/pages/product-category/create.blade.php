...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="card">
              <form method="POST" action="{{ url('/app-admin/product-category') }}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="category_name" class="form-control @error('category_name') is-invalid @enderror" value="{{ old('category_name') }}" required="" placeholder="Nama Kategori" autocomplete="off">
                  ...
                  <div class="form-group">
                    <label for="image_category">Gambar Kategori <span class="text-danger">*</span></label>
                    <input type="file" class="form-control mb-3" name="image_category" id="image_category" onchange="showPreviewImage(this)" required>
                ...
                <div class="card-footer mt-n4">
                  <button type="submit" class="btn btn-primary">Tambahkan Kategori Produk</button>
